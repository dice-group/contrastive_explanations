package anonymized.contrastive.test;
...
public class Test {
    public static void main(String[] args) throws FileNotFoundException, OWLOntologyCreationException {
...

        {
            ...
            ContrastiveExplanationProblem problem =
                    new ContrastiveExplanationProblem(ontology,
                            factory.getOWLClass(IRI.create("http://www.semanticweb.org/ontologies/2025/0/untitled-ontology-247#Interesting")),
                            factory.getOWLNamedIndividual(IRI.create("http://www.semanticweb.org/ontologies/2025/0/untitled-ontology-247#a")),
                            factory.getOWLNamedIndividual(IRI.create("http://www.semanticweb.org/ontologies/2025/0/untitled-ontology-247#b")));
...

        {
            ...
            ContrastiveExplanationProblem problem =
                    new ContrastiveExplanationProblem(ontology,
                            factory.getOWLClass(IRI.create("http://www.semanticweb.org/ontologies/2025/0/untitled-ontology-247#GrandMother")),
                            factory.getOWLNamedIndividual(IRI.create("http://www.semanticweb.org/ontologies/2025/0/untitled-ontology-247#a")),
                            factory.getOWLNamedIndividual(IRI.create("http://www.semanticweb.org/ontologies/2025/0/untitled-ontology-247#b")));
