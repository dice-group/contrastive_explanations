...
public class ContrastivePreferencesPanel extends OWLPreferencesPanel {
    ...
    public void initialise() {
        ...
        c.gridx=1; endpointField = new JTextField(32); add(endpointField, c);

        c.gridx=0; c.gridy=1; add(new JLabel("API Key (if any):"), c);
        c.gridx=1; apiKeyField = new JPasswordField(32); add(apiKeyField, c);

        c.gridx=0; c.gridy=2; add(new JLabel("Graphviz 'dot' path (optional):"), c);
        c.gridx=1; dotPathField = new JTextField(32); add(dotPathField, c);
